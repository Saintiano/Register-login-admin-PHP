						...
						<div class="row">
                           ...
                           <div class="form-group">
								...
								<form id="register-form" action="registration.php" method="post" role="form" style="display: none;">
									<div class="form-group">
										<input type="text" name="fname" id="firstname" tabindex="1" class="form-control" placeholder="First Name" value="" required>
									</div>
                           <div class="form-group">
										<input type="text" name="lname" id="lastname" tabindex="1" class="form-control" placeholder="Last Name" value="" required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<input type="phone" name="phone" id="phone" tabindex="1" class="form-control" placeholder="Phone" value="" required>
									</div>
                           <div class="form-group">
										<input type="country" name="country" id="country" tabindex="1" class="form-control" placeholder="Country" value="" required>
									</div>
                           <div class="form-group">
										<input type="program" name="program" id="program" tabindex="1" class="form-control" placeholder="Program" value="" required>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
